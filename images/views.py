...
def image_create(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            new_image.save()
            create_action(request.user, 'изображение в закладках', new_image)
...
def image_list(request):
    """ Представление бесконечной постраничной
    прокрутки в список изображений. """
